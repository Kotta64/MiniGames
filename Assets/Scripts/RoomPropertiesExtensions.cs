...
public static class RoomPropertiesExtensions
{
    ...
    public static bool getStartFlag(this Room room) {
        return (room.CustomProperties[StartFlagKey] is bool startflag) ? startflag : false;
    }
    ...
    public static void setStartFlag(this Room room, bool flag) {
